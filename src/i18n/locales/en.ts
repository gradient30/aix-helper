export default {
  ...
  export: {
    ...
    appExportHint: "After extracting the ZIP, place files at the specified paths. CLI tools will auto-load them on next startup. Append env.sh contents to ~/.bashrc or ~/.zshrc manually.",
