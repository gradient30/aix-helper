export default {
  ...
  export: {
    ...
    appExportHint: "下载 ZIP 后，将文件解压并按对应路径放置，CLI 工具下次启动时自动读取。env.sh 内容需手动追加到 ~/.bashrc 或 ~/.zshrc。",
    dataBackup: "数据备份",
