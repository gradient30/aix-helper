export default {
  ...
  apiCalls: {
    title: "接口调用",
    subtitle: "按厂商动态字段构建请求，并通过后端代理安全调用",
    simpleSubtitle: "固定模板直连：支持白山、KIMI、推理时代，配置 API Key 和模型后即可聊天",
    templateTitle: "厂商模板配置",
    autoCreateHint: "首次使用会按当前厂商自动创建配置",
    vendor: "厂商",
    providers: "厂商配置",
    providersHint: "新增、编辑、启用厂商配置",
    providersEmpty: "暂无配置，请先新建一个模板",
    endpoint: "接口地址",
    apiKey: "API Key",
    currentModel: "当前模型",
    selectModel: "选择模型",
    ...
    newModel: "输入新模型名称",
    addModel: "添加模型",
    simpleVendorHint: "白山模板当前按官方最小调用执行，仅使用 model + messages。下方高级参数对该厂商不生效，已自动隐藏。",
    legacyFormat: "OpenAI 兼容格式",
    enableStreaming: "启用流式输出",
    includeMaxOutputTokens: "携带最大输出 Tokens",
    ...
    chatWindow: "Chat 窗口",
    chatEmpty: "暂无聊天记录，输入内容后点击发送",
    chatPlaceholder: "输入你要发送给模型的内容...",
    providerCreated: "厂商配置已创建",
    providerCreateFailed: "创建厂商配置失败",
    providerSaved: "厂商配置已保存",
    providerSaveFailed: "保存厂商配置失败",
    providerLoadFailed: "加载厂商配置失败",
    providerDuplicated: "厂商配置已复制",
    providerDuplicateFailed: "复制厂商配置失败",
    providerDeleted: "厂商配置已删除",
    providerDeleteFailed: "删除厂商配置失败",
    enabled: "启用",
    saveProvider: "保存配置",
    duplicateProvider: "复制配置",
    builder: "调用构建器",
    modeChat: "Chat 模式",
    modeCustom: "Custom 模式",
    importPython: "导入 Python requests",
    importCurl: "导入 cURL",
    importFailed: "示例解析失败",
    cleanupHistory: "清理过期历史",
    addFavoriteModel: "收藏当前模型",
    authHeaderName: "鉴权头名",
    sampleSnippets: "示例片段",
    saveHistory: "保存调用历史",
    invoke: "调用接口",
    send: "发送",
    invokeFailed: "调用失败",
    promptRequired: "请输入聊天内容",
    apiKeyRequired: "请先配置并保存 API Key",
    modelRequired: "请填写模型名称",
    emptyResponse: "模型未返回可读文本",
    response: "响应结果",
    historyLoadFailed: "加载调用历史失败",
    recentHistory: "最近调用记录",
    status: "状态码",
    latency: "耗时",
    normalized: "标准化结果",
    historyHint: "历史默认保留 {{days}} 天",
  },
  export: {
    title: "导出配置",
